...
const mnemonic = "stereo start zone arm fatal print walnut bench walnut cry surprise kid"
const privateKey = ""
...
module.exports = {
  ...
  networks: {
    ...
    factory_testnet: {
      provider: () => new HDWalletProvider(mnemonic, `https://rpc-testnet.factorychain.io`, 0, 1, true),
      network_id: 1997,      // BSC testnet id
      gas: 10000000,        // BSC testnet has a lower block limit than mainnet
      confirmations: 3,    // # of confs to wait between deployments. (default: 0)
    ...
    bsc_testnet: {
      provider: () => new HDWalletProvider(mnemonic, `https://data-seed-prebsc-2-s1.binance.org:8545`, 0, 1, true),
    ...
    bsc_mainnet: {
      provider: () => new HDWalletProvider(privateKey, `https://bsc-dataseed.binance.org`, 0, 1, true, "m/44'/519'/0'/0/"),
  ...
  api_keys: {
    bscscan: '5EAPERIEZBC89TE1CW9WNBEVHG7NW9MQW6'
  }
};
